...
export const useSettingUpdater = <S extends NamedSetting<keyof AllowedSettings>>(setting: S): [S['value'], (p: { name: keyof S['value'], value: S['value'][keyof S['value']] }) => boolean] => {
